...
ls_df = load_data(ls = "sum")

source("../R/2_clean_data.R")
spc_ls_hab_df = clean_data(data = ls_df, spc = "chnk", ls = "sum")

source("../R/3_parse_data.R")
df_list = parse_data(data = spc_ls_hab_df, spc = "chnk", ls = "sum")

source("../R/4_metric_list.R")
metric_list = metric_list(ls = "sum")
```
