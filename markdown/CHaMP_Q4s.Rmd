...
The above results give us some idea of those habitat covariates that seem to vary between sites with high observed densities for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")`, `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` and all other sites with lower densities. Let's examine some of those habitat covariates a little further: `r hab_list`. Figure \@ref(fig:chnk-sum-targets) shows the distributions of those habitat covariates comparing sites with high densities (Q4) with lower densities (Rest) for each case where the means were found to be significantly different ($\alpha =$ `r alpha`). These plots could be used to infer target conditions for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")` `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` for those habitat covariates. Additionally, Table \@ref(tab:chnk-sum-table) provides the quartiles, including medians, for those distributions.
...
The above results give us some idea of those habitat covariates that seem to vary between sites with high observed densities for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")`, `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` and all other sites with lower densities. Let's examine some of those habitat covariates a little further: `r hab_list`. Figure \@ref(fig:chnk-win-targets) shows the distributions of those habitat covariates comparing sites with high densities (Q4) with lower densities (Rest) for each case where the means were found to be significantly different ($\alpha =$ `r alpha`). These plots could be used to infer target conditions for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")` `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` for those habitat covariates. Additionally, Table \@ref(tab:chnk-win-table) provides the quartiles, including medians, for those distributions.
...
The above results give us some idea of those habitat covariates that seem to vary between sites with high observed densities for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")`, `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` and all other sites with lower densities. Let's examine some of those habitat covariates a little further: `r hab_list`. Figure \@ref(fig:chnk-spw-targets) shows the distributions of those habitat covariates comparing sites with high densities (Q4) with lower densities (Rest) for each case where the means were found to be significantly different ($\alpha =$ `r alpha`). These plots could be used to infer target conditions for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")` `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` for those habitat covariates. Additionally, Table \@ref(tab:chnk-spw-table) provides the quartiles, including medians, for those distributions.
...
The above results give us some idea of those habitat covariates that seem to vary between sites with high observed densities for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")`, `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` and all other sites with lower densities. Let's examine some of those habitat covariates a little further: `r hab_list`. Figure \@ref(fig:sthd-sum-targets) shows the distributions of those habitat covariates comparing sites with high densities (Q4) with lower densities (Rest) for each case where the means were found to be significantly different ($\alpha =$ `r alpha`). These plots could be used to infer target conditions for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")` `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` for those habitat covariates. Additionally, Table \@ref(tab:sthd-sum-table) provides the quartiles, including medians, for those distributions.
...
The above results give us some idea of those habitat covariates that seem to vary between sites with high observed densities for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")`, `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` and all other sites with lower densities. Let's examine some of those habitat covariates a little further: `r hab_list`. Figure \@ref(fig:sthd-win-targets) shows the distributions of those habitat covariates comparing sites with high densities (Q4) with lower densities (Rest) for each case where the means were found to be significantly different ($\alpha =$ `r alpha`). These plots could be used to infer target conditions for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")` `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` for those habitat covariates. Additionally, Table \@ref(tab:sthd-win-table) provides the quartiles, including medians, for those distributions.
...
The above results give us some idea of those habitat covariates that seem to vary between sites with high observed densities for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")`, `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` and all other sites with lower densities. Let's examine some of those habitat covariates a little further: `r hab_list`. Figure \@ref(fig:sthd-spw-targets) shows the distributions of those habitat covariates comparing sites with high densities (Q4) with lower densities (Rest) for each case where the means were found to be significantly different ($\alpha =$ `r alpha`). These plots could be used to infer target conditions for `r ifelse(spc == "chnk", "Chinook salmon", "steelhead")` `r if(ls == "sum") "summer parr"; if(ls == "win") "winter presmolt"; if(ls == "spw") "adult spawning"` for those habitat covariates. Additionally, Table \@ref(tab:sthd-spw-table) provides the quartiles, including medians, for those distributions.
